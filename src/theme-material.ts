...
const background = new THREE.Color(desktop ? "#15232b" : "#11181b"), floorColor = new THREE.Color(desktop ? "#203039" : "#192125"), mistColor = new THREE.Color(desktop ? "#30434c" : "#263136");
